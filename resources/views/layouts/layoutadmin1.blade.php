      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li @if ($pages === 'kategori') class="active" @endif>
              <a href="{{ route('kategori') }}" class="nav-link"><i class="fab fa-korvue"></i><span>Kategori</span></a>
            </li>

            <li @if ($pages === 'tapel') class="active" @endif>
              <a href="{{ route('tapel') }}" class="nav-link"><i class="fas fa-calendar-alt"></i><span>Tahun
                  Pelajaran</span></a>
            </li>
            <li @if ($pages === 'kelas') class="active" @endif>
              <a href="{{ route('kelas') }}" class="nav-link"><i class="fas fa-school"></i><span>Kelas</span></a>
            </li>
            <li @if ($pages === 'siswa') class="active" @endif>
              <a href="{{ route('siswa') }}" class="nav-link"><i class="fas fa-user-graduate"></i><span>Siswa</span></a>
            </li>
            <li @if ($pages === 'pegawai') class="active" @endif>
            ...
            <li @if ($pages === 'pemasukan') class="active" @endif>
              <a href="{{ route('pemasukan') }}" class="nav-link"><i
                  class="fas fa-hand-holding-usd"></i><span>Pemasukan</span></a>
            </li>

            <li @if ($pages === 'pengeluaran') class="active" @endif>
              <a href="{{ route('pengeluaran') }}" class="nav-link"><i
                  class="fas fa-file-invoice-dollar"></i><span>Pengeluaran</span></a>
            </li>
            <li @if ($pages === 'pembayaran') class="active" @endif>
              <a href="{{ route('pembayaran') }}" class="nav-link"><i
                  class="far fa-money-bill-alt"></i><span>Pembayaran</span></a>
            </li>



            <li class="menu-header">Reporting</li>
            <li @if ($pages === 'laporan') class="active" @endif>
          ...
          <li @if ($pages === 'laporan') class="active" @endif>
            <a href="{{ route('laporan') }}" class="nav-link"><i class="fab fa-korvue"></i><span>Laporan
                Keuangan</span></a>
          </li>

          <li @if ($pages === 'tagihansiswa') class="active" @endif>
            <a href="{{ route('kepsek.tagihansiswa') }}" class="nav-link"><i class="fab fa-korvue"></i><span>Pembayaran
                Siswa</span></a>
          </li>
          ...
          <li @if ($pages === 'tagihansiswa') class="active" @endif>
            <a href="{{ route('siswa.tagihansiswa') }}" class="nav-link"><i
                class="fab fa-korvue"></i><span>Tagihanku</span></a>
          </li>
