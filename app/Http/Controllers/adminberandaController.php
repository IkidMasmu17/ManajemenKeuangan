...
class adminberandaController extends Controller
{
    public function index()
    {
        ...
        $sumpemasukan = DB::table('pemasukan')->whereNotIn('kategori_nama', ['Dana Bos'])->sum('nominal');
        $sumpemasukanbos = DB::table('pemasukan')->where('kategori_nama', 'Dana Bos')->sum('nominal');
        $sumpengeluaran = DB::table('pengeluaran')->whereNotIn('kategori_nama', ['Dana Bos'])->sum('nominal');
        $sumpengeluaranbos = DB::table('pengeluaran')->where('kategori_nama', 'Dana Bos')->sum('nominal');
        $sumtagihansiswa = DB::table('pembayarandetail')->sum('nominal');

        $totalpemasukan = $sumtagihansiswa + $sumpemasukanbos + $sumpemasukan;
        $totalpengeluaran = $sumpengeluaran + $sumpengeluaranbos;
        $sisasaldo = $totalpemasukan - $totalpengeluaran;
        // End Dashboard Calculations

        // $ttlpemasukan logic removed as it is now $totalpemasukan
